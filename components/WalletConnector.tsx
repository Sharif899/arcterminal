      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 12, flexShrink: 0, position: 'relative' }}>
        ...
        <button
          ...
          style={{
            ...
            fontFamily: 'Space Mono, monospace', fontSize: 11, color: '#16a34a',
          }}
        >
        ...
        {showMenu && (
          <>
            ...
            <div style={{
              ...
              borderRadius: 10, padding: 8, minWidth: 220, zIndex: 99,
              ...
              <button
                ...
                style={{ width: '100%', padding: '8px 12px', background: 'none', border: 'none', cursor: 'pointer', textAlign: 'left', fontSize: 12, color: '#5a6478', borderRadius: 6, display: 'flex', alignItems: 'center', gap: 8 }}
              >
                📋 Copy Address
              </button>
              ...
              <button
                ...
                style={{ width: '100%', padding: '8px 12px', background: 'none', border: 'none', cursor: 'pointer', textAlign: 'left', fontSize: 12, color: '#dc2626', borderRadius: 6, display: 'flex', alignItems: 'center', gap: 8 }}
              >
                ✕ Disconnect
              </button>
            </div>
