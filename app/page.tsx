    ...
    <>
      ...
      <div style={{ minHeight: 'calc(100vh - 84px)', display: 'flex', flexDirection: 'column', background: '#ffffff' }}>
            ...
            <div className="hero-grid">
              ...
              <div>
                ...
                <p style={{ fontSize: 17, color: '#5a6478', lineHeight: 1.7, maxWidth: 520, marginBottom: 36 }}>
                  An AI agent that holds Arc wallets, reads market signals, and autonomously sends USDC — no manual clicks required.
                </p>

                <div className="hero-buttons">
                  <Link href="/terminal" className="btn-primary">LAUNCH AGENT →</Link>
                  <Link href="/portfolio" className="btn-outline">VIEW WALLET</Link>
                </div>
              </div>
              ...
              <div className="stats-panel-wrapper">
                <div className="stats-card">
                  <div style={{
                    padding: '14px 20px', borderBottom: '1px solid #e2e6ed',
                    background: '#f8f9fb', display: 'flex', justifyContent: 'space-between', alignItems: 'center',
                  }}>
                    <span style={{ fontSize: 11, fontWeight: 700, letterSpacing: '0.1em', color: '#5a6478' }}>NETWORK · LIVE</span>
                  ...
                  <div style={{ padding: '16px 20px' }}>
                    {[
                      ...
                      <div key={item.label} style={{
                        ...
                        <span style={{ fontSize: 11, color: '#9199aa', letterSpacing: '0.08em', fontWeight: 500 }}>{item.label}</span>
                        <span style={{ fontSize: 12, fontWeight: 700, color: item.flash ? '#2563eb' : '#0f1117', transition: 'color 0.3s' }}>
                          {item.value}
                        </span>
                      </div>
                    ))}
                  ...
                  <div className="panel-footer-btns" style={{
                    ...
                    <Link href="/terminal" className="btn-primary" style={{ flex: 1, fontSize: 11, padding: '9px', textAlign: 'center' }}>LAUNCH AGENT</Link>
                    <Link href="/markets" className="btn-outline" style={{ flex: 1, fontSize: 11, padding: '9px', textAlign: 'center' }}>VIEW SIGNALS</Link>
                  </div>
                </div>
              </div>
              ...
              {features.map((f) => (
                <Link key={f.label} href={f.href} className="feature-card">
                  <div style={{ padding: 20 }}>
                    ...
                    <div style={{ fontWeight: 700, fontSize: 11, color: f.color, letterSpacing: '0.08em', marginBottom: 8 }}>{f.label}</div>
        ...
        <footer style={{ borderTop: '1px solid #e2e6ed', padding: '24px', textAlign: 'center', fontSize: 12, color: '#9199aa' }}>
          Fluxa — Autonomous Agent · Built on Arc Network · Powered by USDC & Circle Nanopayments
        </footer>
