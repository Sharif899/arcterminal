...
export default function StorefrontPage() {
  ...
  return (
    <div style={{ padding: '24px 24px 60px', maxWidth: 1200, margin: '0 auto', position: 'relative', zIndex: 1 }}>
      ...
      {checkoutProduct && (
        <div style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.7)', backdropFilter: 'blur(4px)', zIndex: 200, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 20 }} onClick={() => setCheckoutProduct(null)}>
          <div style={{ background: '#080c10', border: '1px solid rgba(0,255,136,0.2)', borderRadius: 12, padding: 28, width: '100%', maxWidth: 440, maxHeight: '90vh', overflowY: 'auto' }} onClick={e => e.stopPropagation()}>
            ...
            {!address && (
              <div style={{ marginTop: 14, padding: '10px 14px', background: 'rgba(255,170,0,0.08)', border: '1px solid rgba(255,170,0,0.2)', borderRadius: 6, fontFamily: 'Space Mono, monospace', fontSize: 12, color: '#ffaa00' }}>Connect your wallet to pay</div>
            )}
